...
<body>
    ...
    <div class="container mt-4">
        <form class="p-4" method="POST" action="../BackEnd/RealizarVenta.php">
            <div class="mb-3">
                <label for="exampleInputEmail1">Id producto</label>
                <select class="form-select" aria-label="Default select example" name="txtIdproducto">
                    <?php include '/wamp64/www/Cafeteria_KONECTA/BackEnd/ListaProductoVenta.php' ?>
                </select>
            </div>

            <div class="form-group mb-3">
                <label for="exampleInputEmail1">Cantidad</label>
                <input type="text" class="form-control" class="form-control" name="txtCantidad" autofocus placeholder="Ingrese la cantidad">
            </div>
            <div class="form-group mb-3">
            </div>
